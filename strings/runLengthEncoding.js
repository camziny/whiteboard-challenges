...
// special characters, including numbers. And since encoded data must be decodable, this means
// that we can't naively run-length-encode long runs. For example, the run, "AAAAAAAAAAAA"
// (12 As), can't naively be encoded as "12A", since this string can be decoded as either
// "AAAAAAAAAAAA" or "1AA". Thus, long runs (runs of 10 or more characters) should be encoded
